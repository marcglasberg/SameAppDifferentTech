...
/// ```
///
/// Note: Once an action with `RespectRunConfig` is used the first time, it will
/// change the behavior of the `CheckInternet` mixin for all other actions that
/// use it. Instead of using this mixin, this code could also be put into the
/// app initialization code, and in the tests initialization code. But this
/// mixin is more convenient.
///
